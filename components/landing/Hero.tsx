...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden pt-20">
      <div className="absolute inset-0 bg-gradient-to-br from-navy-50 via-background to-electric-50/40 dark:from-navy-950 dark:via-black dark:to-navy-950"></div>

      <div className="absolute inset-0 opacity-30 dark:opacity-100">
        <div className="absolute top-20 left-10 w-72 h-72 bg-electric-500 rounded-full blur-3xl opacity-40 dark:opacity-100"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-navy-600 rounded-full blur-3xl opacity-40 dark:opacity-100"></div>
      </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative">
              ...
              <div className="relative glass-card rounded-3xl p-8 space-y-6">
                <div className="aspect-square rounded-2xl bg-gradient-to-br from-navy-100 via-electric-50/50 to-navy-200 dark:from-navy-700 dark:via-navy-800 dark:to-navy-900 flex items-center justify-center border border-border dark:border-white/10">
                  <div className="text-center">
                    <div className="w-40 h-40 mx-auto mb-6 rounded-full bg-gradient-to-br from-electric-500/20 to-navy-600/20 flex items-center justify-center border-4 border-electric-500/30">
                      <svg className="w-24 h-24 text-electric-500 dark:text-electric-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                    </div>
                    <h3 className="text-2xl font-bold text-foreground dark:text-white mb-2">Proteção Total</h3>
                    <p className="text-muted-foreground dark:text-gray-300">Seu veículo sempre seguro.</p>
                  </div>
                </div>
              </div>
            </div>
